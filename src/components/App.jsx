...
function App() {
  ...
  return (
      ...
      <PopupWithForm title='Редактировать профиль' name='edit-profile' isOpen={isEditProfilePopupOpen} buttonName='Сохранить' buttonType='save'>
      ...
      <PopupWithForm title='Новое место' name='new-card' buttonName='Добавить' buttonType='create' isOpen={isAddPlacePopupOpen}>
      ...
      <PopupWithForm title='Вы уверены?' name='before_deleting' buttonName='Вы уверены' >
      ...
      <PopupWithForm title='Обновить аватар' name='update_avatar'  buttonName='Сохранить' buttonType='save' isOpen={isEditAvatarPopupOpen}>
